...
class UserController @Autowired constructor(val userService: UserService) {
    ...
    fun find(@PathVariable(name = "username") username: String): ResponseEntity<UserDto> {
        val response: ResponseEntity<UserDto> = try {
            ResponseEntity<UserDto>(userService.findUserFromUsername(username), HttpStatus.OK)
